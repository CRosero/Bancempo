...
class TimeSlotListFragment : Fragment(R.layout.fragment_time_slot_list) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (skill == null) {
            ...
            if (myInterests != null && myInterests) {
                ...
                sharedVM.conversations.observe(viewLifecycleOwner) { convs ->
                    ...
                    if (advs != null && convs != null) {
                        ...
                        renderAdvList(interests.toList(), false)
                    }
                    ...
                    sb.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
                        override fun onQueryTextChange(newText: String): Boolean {
                            ...
                            renderAdvList(newMyInterestsAdvs, false)
                            return false
                        }
                        ...
                        if (pos == 0) {
                            ...
                            sharedVM.conversations.observe(viewLifecycleOwner) { convs ->
                                ...
                                if (advs != null && convs != null) {
                                    ...
                                    renderAdvList(reservations.toList(), false)
                                }
                            }
                        } else if (pos == 1) {
                            //BY OTHERS
                ...
                sharedVM.myAdvs.observe(viewLifecycleOwner) { sadvs ->
                    ...
                    renderAdvList(sadvs.values.toList().sortedBy { adv -> adv.title }, true)
            ...
            sharedVM.advs.observe(viewLifecycleOwner) { sadvs ->
                ...
                renderAdvList(searchListOfAdvs, false)
    ...
    private fun renderAdvList(advList: List<SmallAdv>, myAdv: Boolean) {
        val adapter: com.bancempo.SmallAdvAdapter?

        if (!myAdv) {
            adapter =
                SmallAdvAdapter1(advList, false, sharedVM)
        } else {
            adapter =
                SmallAdvAdapter1(advList, true, sharedVM)
        }
